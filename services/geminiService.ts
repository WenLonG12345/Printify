...
export const generateLoveNote = async (userPrompt?: string): Promise<string> => {
  ...
  try {
    const response = await aiClient.models.generateContent({
      ...
      contents: prompt,
      config: {
        systemInstruction: "You are a creative writer who writes succinct, charming notes for receipts.",
